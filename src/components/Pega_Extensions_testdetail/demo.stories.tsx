...
import PegaExtensionsTestdetail from './index';
...
const meta: Meta<typeof PegaExtensionsTestdetail> = {
  title: 'PegaExtensionsTestdetail',
  component: PegaExtensionsTestdetail,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof PegaExtensionsTestdetail>;
...
export const BasePegaExtensionsTestdetail: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <>
      <PegaExtensionsTestdetail {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        />
      </PegaExtensionsTestdetail>
    </>
  );
};

BasePegaExtensionsTestdetail.args = {
  showLabel: true,
