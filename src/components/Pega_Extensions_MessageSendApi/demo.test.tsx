...
const { BasePegaExtensionsMessageSendApi } = composeStories(DemoStories);

test('renders PegaExtensionsMessageSendApi', async () => {
  render(<BasePegaExtensionsMessageSendApi />);
