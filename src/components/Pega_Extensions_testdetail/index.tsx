...
import StyledPegaExtensionsTestdetailWrapper, { StyledDetailsGridContainer, StyledHighlightedFieldsHrLine } from './styles';

// includes in bundle
import { getAllFields } from './utils';

// interface for props
interface PegaExtensionsTestdetailProps extends PConnFieldProps {
...
function PegaExtensionsTestdetail(props: PegaExtensionsTestdetailProps) {
  ...
  return (
    <StyledPegaExtensionsTestdetailWrapper>
...
export default withConfiguration(PegaExtensionsTestdetail);
